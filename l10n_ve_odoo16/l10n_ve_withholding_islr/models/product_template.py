...
class ProductTemplate(models.Model):
	...
	apply_withholding_islr = fields.Boolean(string='Aplica retención de ISLR', default=False)
	islr_concept_id = fields.Many2one('account.islr.concept', string='Concepto de ISLR', ondelete='restrict')
