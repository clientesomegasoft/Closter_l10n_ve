...
class AccountMove(models.Model):
	...
	def _compute_name(self):
		...
		for move in self:
			if move.is_sale_document() and move.name in (False, '/') and move.state == 'posted' and move.journal_id.invoice_name_sequence_id:
	...
	def action_post(self):
		...
		if self.is_sale_document() and not self.nro_ctrl and self.journal_id.nro_ctrl_sequence_id:
