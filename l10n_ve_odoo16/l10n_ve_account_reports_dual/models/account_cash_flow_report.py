...
class CashFlowReportCustomHandler(models.AbstractModel):
    ...
    def _compute_liquidity_balance(self, report, options, currency_table_query, payment_account_ids, date_scope):
        ...
        if options.get('selected_currency') != self.env.company.currency_ref_id.id:
            return super(CashFlowReportCustomHandler, self)._compute_liquidity_balance(report, options, currency_table_query, payment_account_ids, date_scope)
    ...
    def _get_liquidity_moves(self, report, options, currency_table_query, payment_account_ids, payment_move_ids, cash_flow_tag_ids):
        ...
        if options.get('selected_currency') != self.env.company.currency_ref_id.id:
            return super(CashFlowReportCustomHandler, self)._get_liquidity_moves(report, options, currency_table_query, payment_account_ids, payment_move_ids, cash_flow_tag_ids)
    ...
    def _get_reconciled_moves(self, report, options, currency_table_query, payment_account_ids, payment_move_ids, cash_flow_tag_ids):
        ...
        if options.get('selected_currency') != self.env.company.currency_ref_id.id:
            return super(CashFlowReportCustomHandler, self)._get_reconciled_moves(report, options, currency_table_query, payment_account_ids, payment_move_ids, cash_flow_tag_ids)
        if not payment_move_ids:
            return []
