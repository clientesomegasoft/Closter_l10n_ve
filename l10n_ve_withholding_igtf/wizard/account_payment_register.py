...
class AccountPaymentRegister(models.TransientModel):
	...
	apply_igtf = fields.Selection([('cash', 'Cash'), ('bank', 'Bank')], compute='_compute_apply_igtf')
	calculate_igtf = fields.Boolean(string='Permitir IGTF', default=True)
	igtf_journal_id = fields.Many2one('account.journal', string='Diario IGTF', check_company=True, domain="[('type', 'in', ('bank', 'cash'))]")
