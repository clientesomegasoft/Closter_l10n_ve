    ...
    OrgChart.prototype = {
        ...
        switchHorizontalArrow: function ($node) {
            ...
            if (
                ...
                $node
                    .children(".leftEdge")
                    .toggleClass("fa-chevron-right", sibsVisible)
                    .toggleClass("fa-chevron-left", !sibsVisible);
                $node
                    .children(".rightEdge")
                    .toggleClass("fa-chevron-left", sibsVisible)
                    .toggleClass("fa-chevron-right", !sibsVisible);
        ...
        createGhostNode: function (event) {
            ...
            nodeCover.setAttribute("stroke-width", Number(scale));
        ...
        dropHandler: function (event) {
            ...
            if (!$dropZone.closest("tr").siblings().length) {
                ...
                $dropZone
                    ...
                    .parent()
                    .after(
                        '<tr class="lines"><td colspan="2"><div class="lineDown"></div></td></tr>' +
                ...
                $dropZone
                    ...
                    .children(":last")
                    .before(
                        '<td class="lineLeft lineTop"></td><td class="lineRight lineTop"></td>'
                    )
                    .end()
                    .next()
            ...
            if (opts.verticalLevel && level >= opts.verticalLevel) {
                ...
                if (Number(flags.substr(2, 1))) {
                    $nodeDiv
                        ...
                        .children(".title")
                        .prepend(
                            '<i class="fa ' + opts.parentNodeSymbol + ' symbol"></i>'
                        );
                }
            }
        ...
        buildHierarchy: function ($appendTo, data) {
            ...
            if (hasChildren) {
                ...
                var isVerticalLayer = Boolean(
                    opts.verticalLevel && level + 1 >= opts.verticalLevel
                );
                var $nodesLayer;
                if (isVerticalLayer) {
                    $nodesLayer = $("<ul>");
                    ...
                    var $upperLines = $(
                        '<tr class="lines' +
                            ...
                            '"><td colspan="' +
                            childrenData.length * 2 +
                            '"><div class="lineDown"></div></td></tr>'
                    );
                    var lowerLines =
                        '<tr class="lines' + isHidden + '"><td class="lineRight"></td>';
        ...
        buildParentNode: function ($currentRoot, data) {
            ...
            var $table = $("<table>")
                .append(
                    $("<tr>").append(
                        $('<td colspan="2">').append(this.createNode(data))
                    )
                )
                .append(
                    '<tr class="lines"><td colspan="2"><div class="lineDown"></div></td></tr>'
                ...
                if (existingSibligCount > 1) {
                    this.complementLine(
                        $siblingTds
                            .eq(0)
                            .before(
                                $nodeChart.closest("td").siblings().addBack().unwrap()
                            ),
                        siblingCount,
                        existingSibligCount
                    );
            ...
            html2canvas(sourceChart, {
                ...
                onrendered: function (canvas) {
                    ...
                    if (exportFileextension.toLowerCase() === "pdf") {
                        ...
                        var isFf = Boolean(window.sidebar);
                        var isEdge =
