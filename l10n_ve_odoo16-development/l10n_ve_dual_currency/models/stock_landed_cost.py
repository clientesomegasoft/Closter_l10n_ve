...
class StockLandedCostLine(models.Model):
	...
	currency_ref_id = fields.Many2one('res.currency', default=lambda self: self.env.company.currency_ref_id.id, required=True)
	currency_rate_ref = fields.Many2one(
		comodel_name='res.currency.rate',
		string='Tasa de cambio', ondelete='restrict', required=True,
