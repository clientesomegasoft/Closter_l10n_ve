...
class ResPartner(models.Model):
	...
	currency_ref_id = fields.Many2one('res.currency', compute='_get_company_currency_ref')
	total_due_ref = fields.Monetary(string='Adeudado total ope.', compute='_compute_total_due', currency_field='currency_ref_id', groups='account.group_account_readonly,account.group_account_invoice')
	total_overdue_ref = fields.Monetary(string='Total vencido ope.', compute='_compute_total_due', currency_field='currency_ref_id', groups='account.group_account_readonly,account.group_account_invoice')
