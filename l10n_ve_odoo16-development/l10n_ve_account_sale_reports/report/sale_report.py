...
class SaleReport(models.Model):
    ...
    untaxed_amount_to_invoice_ref = fields.Float(
        string   = 'Untaxed Amount To Invoice Ref',
        readonly = True)

    untaxed_amount_invoiced_ref = fields.Float(
        string   = 'Untaxed Amount Invoiced Ref',
        readonly = True)

    discount_amount_ref = fields.Float(
        string   = 'Discount Amount Ref',
        readonly = True)

    margin_ref = fields.Float(
        string   = 'Margin Ref',
        readonly = True)
