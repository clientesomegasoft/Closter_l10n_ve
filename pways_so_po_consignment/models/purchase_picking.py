...
class PurchaseOrder(models.Model):
    ...
    def _get_location_picking(self, location_id):
        moves = self.picking_ids.mapped('move_lines').filtered(lambda x: x.location_id == location_id)
                ...
                if location_ids:
                    ...
                    for location in location_ids:
                        ...
                        if not pickings:
                            ...
                            picking = pickings[0]
                        moves = order.order_line.filtered(lambda x: x.location_id == location)._create_stock_moves(picking)
