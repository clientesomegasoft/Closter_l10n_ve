            ...
            base_tax_line_mapping AS (
                ...
                */
                ...
                SELECT
                    ...
                    base_line.id AS base_line_id,
                    {"base_line.balance AS base_amount," if not self._context.get('ref_report') else "base_line.balance_ref AS base_amount,"}
                    {"base_line.amount_currency AS base_amount_currency" if not self._context.get('ref_report') else "base_line.balance_ref AS base_amount_currency"}
            ...
            tax_amount_affecting_base_to_dispatch AS (
                ...
                */
                ...
                SELECT
                    ...
                    {"account_move_line.balance AS total_tax_amount," if not self._context.get('ref_report') else "account_move_line.balance_ref AS total_tax_amount,"}

                    {"base_line.amount_currency AS base_amount_currency," if not self._context.get('ref_report') else "account_move_line.balance_ref AS base_amount_currency,"}
                    SUM(
                        CASE WHEN tax.amount_type = 'fixed'
                    ...
                    {"account_move_line.amount_currency AS total_tax_amount_currency" if not self._context.get('ref_report') else "account_move_line.balance_ref AS total_tax_amount_currency"}
            ...
            base_tax_matching_all_amounts AS (
                ...
                */
                ...
                SELECT
                    ...
                    {"tax_line.balance AS total_tax_amount," if not self._context.get('ref_report') else "tax_line.balance_ref AS total_tax_amount,"}
                    ...
                    {"tax_line.amount_currency AS total_tax_amount_currency" if not self._context.get('ref_report') else "tax_line.balance_ref AS total_tax_amount_currency"}
