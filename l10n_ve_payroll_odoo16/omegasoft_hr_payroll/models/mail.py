...
class Mail(models.Model):
    ...
    def _send_with_template(self, payslip, auto_commit=False, raise_exception=False, smtp_session=None):
...
class Mail(models.Model):
    ...
    def send_mail_template(self, res_id, payslip, force_send=False, raise_exception=False, email_values=None, notif_layout=False):
