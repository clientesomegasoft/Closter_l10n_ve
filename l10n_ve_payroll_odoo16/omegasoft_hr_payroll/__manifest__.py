# -*- coding: utf-8 -*-
{
    ...
    """,
    'depends': ['hr', 'hr_payroll', 'mail', 'omegasoft_res_currency_payroll_rate', 'omegasoft_payroll_res_config_settings', 'omegasoft_contract_utility_liabilities_fields', 'omegasoft_contract_salary_fields', 'omegasoft_salary_bonuses_fields'],
    'data' : [
