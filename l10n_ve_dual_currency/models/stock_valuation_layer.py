    ...
    def _validate_accounting_entries(self):
        ...
        for svl in self:
            ...
            if svl.company_id.anglo_saxon_accounting:
                svl.stock_move_id._get_related_invoices()._stock_account_anglo_saxon_reconcile_valuation(  # noqa: B950
        ...
        for move in self.filtered(
            ...
            move.product_id.with_company(move.company_id.id).with_context(
            ...
            ).sudo().write(
                {
                    ...
                    "standard_price_ref": new_std_price
                    * move.company_id.currency_ref_id.rate,
                }
            )
