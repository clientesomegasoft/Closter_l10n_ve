# -*- coding: utf-8 -*-
{
    ...
    """,
    'depends': ['base','hr','hr_payroll','mail','portal', 'omegasoft_hr_employee_family_information', 'omegasoft_res_currency_payroll_rate', 'omegasoft_payroll_res_config_settings' ],
    'data': [
