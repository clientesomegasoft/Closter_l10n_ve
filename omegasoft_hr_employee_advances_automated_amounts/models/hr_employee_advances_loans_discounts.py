...
class HrEmployeeAdvancesLoansDiscounts(models.Model):
    ...
    @api.onchange(
        ...
        "company_id",
        "employee_ids",
        "use_available_amount_per_employee",
        "shared_type_advance_loan",
    )
    ...
    def _employee_advances_loans_discounts_lines_to_create(self):
        ...
        for employee in self.employee_ids:
            benefits = employee._get_employee_available_benefits(
                self.shared_type_advance_loan, self.company_currency, self.rate_id
            )
                ...
                to_append = fields.Command.create(
                    {
                        ...
                        "employee_file_code_ids": [
                            fields.Command.link(employee.employee_file_code_id.id)
                        ],
                        "type_advance_loan": (
