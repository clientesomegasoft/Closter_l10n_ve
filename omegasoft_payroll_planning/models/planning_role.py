...
class PlanningRole(models.Model):
    ...
    hr_job_id = fields.Many2one(comodel_name='hr.job', string='Workstation', ondelete='restrict')
    ...
    def onchange_hr_job(self):
        ...
        if self.hr_job_id:
            ...
            for record in employees:
                roles = list(set([role.name for role in record.default_planning_role_id] + [role.name for role in record.planning_role_ids]))
